...
export default function DashboardPage() {
  ...
  const SAMPLE_HOLDINGS = [
    {
      bondimage: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?auto=format&fit=crop&w=600&q=80", // Financial Document / Ledger
    ...
    {
      bondimage: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=600&q=80", // Corporate Strategy / Business Contract
    ...
    {
      bondimage: "https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?auto=format&fit=crop&w=600&q=80", // Municipal / Government Office Building
    ...
    {
      bondimage: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=600&q=80", // Green Mountains / Sustainability
    ...
    {
      bondimage: "https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?auto=format&fit=crop&w=600&q=80", // Currency / Financial Security
    ...
    {
      bondimage: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=600&q=80", // Technology Charts & Screens
    ...
    {
      bondimage: "https://images.unsplash.com/photo-1541888946425-d81bb19240f5?auto=format&fit=crop&w=600&q=80", // Infrastructure Construction / Bridges
    ...
    {
      bondimage: "https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?auto=format&fit=crop&w=600&q=80", // Stock Market Dashboard / Inflation Protection
    ...
    {
      bondimage: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=600&q=80", // Logistics Warehouse / Supply Chain
    ...
    {
      bondimage: "https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&w=600&q=80", // Premium Corporate Executive Setting
      ...
      <div className="mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8 py-6 sm:py-8 flex flex-col gap-8 grow">
        ...
        {loading ? (
          ...
          <>
            ...
            {activeTab === "portfolio" && (
              <Portfolio holdings={SAMPLE_HOLDINGS} graphDataMap={graphDataMap} />
            )}
