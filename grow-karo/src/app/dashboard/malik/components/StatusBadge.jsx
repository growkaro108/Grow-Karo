...
export function StatusBadge({ status }) {
  const map = {
    ...
    scheme_enrolled: "bg-emerald-500/10 text-emerald-400 ring-emerald-500/30",
    approved: "bg-emerald-500/10 text-emerald-400 ring-emerald-500/30",
    Reinvested: "bg-emerald-500/20 text-emerald-500 ring-emerald-500/40",
    scheme_reinvested: "bg-emerald-500/20 text-emerald-500 ring-emerald-500/40",
    matured: "bg-indigo-500/10 text-indigo-400 ring-indigo-500/30",
    ...
    true: "bg-emerald-500/10 text-emerald-400 ring-emerald-500/30",
    false: "bg-rose-500/10 text-rose-400 ring-rose-500/30",
    ...
    withdrawal_processed: "bg-green-500/10 text-green-400 ring-green-500/30",
