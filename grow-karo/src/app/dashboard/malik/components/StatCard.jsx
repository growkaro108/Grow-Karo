export default function StatCard({ icon: Icon, label, value, delta, deltaPositive, accent, textcolor }) {
  return (
    <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5 shadow-sm backdrop-blur-sm">
      <div className="flex items-center justify-between">
        ...
        <span className={`flex h-9 w-9 items-center justify-center rounded-xl ${accent} ${textcolor}`}>
