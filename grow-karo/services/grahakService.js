...
const mockGrahakData = {
  ...
  transactions: [
    {
      id: "TXN-1001",
      date: "2026-07-03",
      description: "Dividend Payout - AAPL",
      type: "Credit",
      amount: 125.5,
      status: "Completed",
    },
    ...
    },
    {
      id: "TXN-1003",
      date: "2026-06-28",
      description: "Equity Purchase - TSLA",
      type: "Debit",
      amount: 1200.0,
      status: "Completed",
    },
  ...
  graphDataMap: {
    AAPL: {
      ...
      prices: [175, 177, 176, 179, 180.5],
    },
    MSFT: {
      labels: ["Mon", "Tue", "Wed", "Thu", "Fri"],
      prices: [410, 415, 412, 418, 420.2],
    },
    TSLA: {
      labels: ["Mon", "Tue", "Wed", "Thu", "Fri"],
      prices: [185, 180, 172, 174, 175.0],
    },
    AMZN: {
      labels: ["Mon", "Tue", "Wed", "Thu", "Fri"],
      prices: [180, 182, 181, 184, 185.1],
    },
  },
};
...
export async function userSignup(payload) {
  try {
    ...
    throw new Error(
      payloadMessage || error.message || "Signup failed. Please try again.",
    );
  }
}
